...
assert.match(sessionCss, /\.board-top-actions\s*\{[^}]*--board-tool-rail-width:\s*42px;/s);
...
assert.match(sessionCss, /\.board-ink-toolbar\s*\{[^}]*--board-tool-rail-width:\s*42px;/s);
...
assert.match(sessionCss, /\.board-ink-toolbar\s*\{[^}]*max-height:\s*calc\(100% - 122px\);/s);
